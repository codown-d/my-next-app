...
export const TzEffectButton = (
  props: WaveConfig & ButtonProps & { effectType: "inset" | "shake" | "happy" }
) => {
  ...
  const realButtonProps = useMemo(() => {
    return {
      ...otherProps,
    };
  }, [props]);
  return effectType === "happy" ? (
    <HappyProvider>
      <TzButton {...realButtonProps} />
    </HappyProvider>
  ) : (
    <ConfigProvider wave={realProps}>
      <TzButton {...realButtonProps} />
    </ConfigProvider>
  );
};
